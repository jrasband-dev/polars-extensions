...
class UnitExtensionNamespace:
    ...
    def fahrenheit_to_celsius(self) -> pl.Expr:
        ...
        """
        return self._apply_expr((self._expr - 32) * 5 / 9)

    def celsius_to_fahrenheit(self) -> pl.Expr:
        """Convert Celsius to Fahrenheit."""
        return self._apply_expr((self._expr * 9 / 5) + 32)

    def celsius_to_kelvin(self) -> pl.Expr:
        """Convert Celsius to Kelvin."""
        return self._apply_expr(self._expr + 273.15)
    ...
    def kelvin_to_rankine(self) -> pl.Expr:
        ...
        return self._apply_expr(self._expr * 9 / 5)

    def rankine_to_kelvin(self) -> pl.Expr:
        """Convert Rankine to Kelvin."""
        return self._apply_expr(self._expr * 5 / 9)
    ...
    def yards_to_meters(self) -> pl.Expr:
        ...
        """
        return self._apply_expr(self._expr * 0.9144)
    ...
    def meters_to_feet(self) -> pl.Expr:
        ...
        return self._apply_expr(self._expr * 3.28084)

    def centimeters_to_inches(self) -> pl.Expr:
        """Convert centimeters to inches."""
        return self._apply_expr(self._expr / 2.54)

    def meters_to_kilometers(self) -> pl.Expr:
        """Convert meters to kilometers."""
        return self._apply_expr(self._expr / 1000)

    def kilometers_to_miles(self) -> pl.Expr:
        """Convert kilometers to miles."""
        return self._apply_expr(self._expr / 1.60934)

    def meters_to_nautical_miles(self) -> pl.Expr:
        """Convert meters to nautical miles."""
        return self._apply_expr(self._expr / 1852)

    def meters_to_light_years(self) -> pl.Expr:
        """Convert meters to light years."""
        return self._apply_expr(self._expr / 9.4607e15)

    def pounds_to_kilograms(self) -> pl.Expr:
        """Convert pounds to kilograms."""
        return self._apply_expr(self._expr * 0.45359237)
    ...
    def grams_to_ounces(self) -> pl.Expr:
        ...
        return self._apply_expr(self._expr / 28.3495)

    def kilograms_to_stones(self) -> pl.Expr:
        """Convert kilograms to stones."""
        return self._apply_expr(self._expr / 6.35029)

    def gallons_to_liters(self) -> pl.Expr:
        """Convert gallons to liters."""
        return self._apply_expr(self._expr * 3.78541)
    ...
    def milliliters_to_fluid_ounces(self) -> pl.Expr:
        ...
        return self._apply_expr(self._expr / 29.5735)

    def calories_to_joules(self) -> pl.Expr:
        """Convert calories to joules."""
        return self._apply_expr(self._expr * 4.184)
    ...
    def joules_to_kwh(self) -> pl.Expr:
        ...
        return self._apply_expr(self._expr / 3.6e6)

    def joules_to_btus(self) -> pl.Expr:
        """Convert joules to BTUs."""
        return self._apply_expr(self._expr / 1055.06)

    def joules_to_therms(self) -> pl.Expr:
        """Convert joules to therms."""
        return self._apply_expr(self._expr / 1.055e8)

    def kph_to_mps(self) -> pl.Expr:
        """Convert kilometers per hour to meters per second."""
        return self._apply_expr(self._expr / 3.6)
    ...
    def mps_to_knots(self) -> pl.Expr:
        ...
        return self._apply_expr(self._expr * 1.94384)

    def sq_feet_to_sq_meters(self) -> pl.Expr:
        """Convert square feet to square meters."""
        return self._apply_expr(self._expr * 0.092903)
